...
"[project]/app/api/auctions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "GET",
    ()=>GET,
    "generateRandomPropertyWithSeed",
    ()=>generateRandomPropertyWithSeed
]);
...
function generateRandomPropertyWithSeed(seed) {
    ...
    switch(propertyType){
        ...
        case "단독주택":
            ...
            const houseType = houseTypes[Math.abs(seedHash >> 56) % houseTypes.length];
        ...
        case "원룸":
            ...
            const oneroomType = oneroomTypes[Math.abs(seedHash >> 56) % oneroomTypes.length];
    ...
    switch(propertyType){
        case "아파트":
            ...
            imageUrl = apartmentImages[Math.abs(seedHash >> 88) % apartmentImages.length];
            break;
        case "오피스텔":
            ...
            imageUrl = officetelImages[Math.abs(seedHash >> 88) % officetelImages.length];
            break;
        case "빌라":
            const villaImages = [
                "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop",
        ...
        case "상가":
            ...
            imageUrl = commercialImages[Math.abs(seedHash >> 88) % commercialImages.length];
            break;
        case "단독주택":
            const houseImages = [
                "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop",
...
function generateRandomProperty() {
    ...
    switch(propertyType){
        case "아파트":
            ...
            const apartmentName = apartmentBrands[Math.floor(Math.random() * apartmentBrands.length)];
        ...
        case "오피스텔":
            ...
            const officetelName = officetelBrands[Math.floor(Math.random() * officetelBrands.length)];
        ...
        case "상가":
            ...
            const commercialName = commercialNames[Math.floor(Math.random() * commercialNames.length)];
        ...
        case "원룸":
            ...
            const oneroomType = oneroomTypes[Math.floor(Math.random() * oneroomTypes.length)];
    ...
    switch(propertyType){
        case "아파트":
            ...
            imageUrl = apartmentImages[Math.floor(Math.random() * apartmentImages.length)];
            break;
        case "오피스텔":
            const officetelImages = [
                "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&h=300&fit=crop",
            ...
            imageUrl = officetelImages[Math.floor(Math.random() * officetelImages.length)];
            break;
        case "빌라":
            const villaImages = [
                "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop",
        ...
        case "상가":
            ...
            imageUrl = commercialImages[Math.floor(Math.random() * commercialImages.length)];
            break;
        case "단독주택":
            const houseImages = [
                "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop",
        ...
        case "원룸":
            ...
            imageUrl = oneroomImages[Math.floor(Math.random() * oneroomImages.length)];
            break;
        default:
            imageUrl = `https://images.unsplash.com/photo-${Math.floor(Math.random() * 1000000000)}?w=400&h=300&fit=crop`;
    }
...
async function GET(request) {
    try {
        ...
        console.log(`✅ 페이지 ${page}/${totalPages}: ${paginatedItems.length}개의 매물을 반환했습니다`);
        // 성공 응답 반환
...
//# sourceMappingURL=%5Broot-of-the-server%5D__841b02cc._.js.map